...
// (DO NOT EDIT: machine generated header) 'System.Net.HttpClient.pas' rev: 35.00 (Windows)
...
public:
	...
	System::UnicodeString __fastcall GetServerCookie();
};
...
public:
	...
	/* {System_Generics_Collections}TList<System_Net_HttpClient_TCookie>.Create */ inline __fastcall TCookies(const TCookie *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<TCookie>(Values, Values_High) { }
...
protected:
	...
	virtual bool __fastcall GetDecompressResponse();
...
private:
	...
	THTTPProtocolVersion FProtocolVersion;
...
protected:
	...
	virtual void __fastcall ExecuteHTTP(const _di_IHTTPRequest ARequest, System::Classes::TStream* const AContentStream, const _di_IHTTPResponse AResponse);
...
#ifndef _WIN64
	void __fastcall CreateFormFromStrings(System::Classes::TStrings* const ASource, System::Sysutils::TEncoding* const AEncoding, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders, System::Classes::TStream* &ASourceStream, System::DynamicArray<System::Net::Urlclient::TNameValuePair> &ASourceHeaders);
