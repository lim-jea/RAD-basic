...
// (DO NOT EDIT: machine generated header) 'REST.Response.Adapter.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TCustomRESTRequestDataSetAdapter;
class DELPHICLASS TRESTRequestDataSetAdapter;
//-- type declarations -------------------------------------------------------
...
class PASCALIMPLEMENTATION TCustomRESTRequestDataSetAdapter : public System::Classes::TComponent
{
	typedef System::Classes::TComponent inherited;
...
private:
	...
	#pragma pack(push,4)
#endif /* not _WIN64 */
	class PASCALIMPLEMENTATION TNotify : public Rest::Client::TCustomRESTRequest::TNotify
	{
		typedef Rest::Client::TCustomRESTRequest::TNotify inherited;
		
	private:
		TCustomRESTRequestDataSetAdapter* FOwner;
		
	protected:
		__fastcall TNotify(TCustomRESTRequestDataSetAdapter* const AOwner);
		
	public:
		virtual void __fastcall ParameterValuesNeeded(System::TObject* Sender);
	public:
		/* TObject.Destroy */ inline __fastcall virtual ~TNotify() { }
...
private:
	Data::Dbjson::TDataSetToJSONBridge* FBridge;
	TNotify* FNotify;
	Rest::Client::TCustomRESTRequest* FRequest;
	bool FAutoUpdate;
	bool FAutoCreateParam;
	System::UnicodeString FParamName;
	Data::Db::TDataSet* __fastcall GetDataSet();
	void __fastcall SetDataSet(Data::Db::TDataSet* const AValue);
	System::Classes::TStrings* __fastcall GetFieldNames();
	void __fastcall SetFieldNames(System::Classes::TStrings* const AValue);
	void __fastcall SetRequest(Rest::Client::TCustomRESTRequest* const AValue);
	Data::Dbjson::TJSONDataSetArea __fastcall GetArea();
	void __fastcall SetArea(const Data::Dbjson::TJSONDataSetArea AValue);
	Data::Db::TFilterRecordEvent __fastcall GetOnFilterRecord();
	void __fastcall SetOnFilterRecord(const Data::Db::TFilterRecordEvent AValue);
	bool __fastcall GetIncludeNulls();
	void __fastcall SetIncludeNulls(const bool AValue);
	void __fastcall SetParamName(const System::UnicodeString AValue);
	void __fastcall ParameterValuesNeeded();
	Rest::Client::TRESTRequestParameter* __fastcall GetParameter();
	void __fastcall CheckRequest();
	void __fastcall CheckDataSet();
	System::UnicodeString __fastcall GetActualParameter();
	
protected:
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	
public:
	__fastcall virtual TCustomRESTRequestDataSetAdapter(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TCustomRESTRequestDataSetAdapter();
	void __fastcall ClearParameter();
	void __fastcall UpdateParameter();
	__property Rest::Client::TRESTRequestParameter* Parameter = {read=GetParameter};
	__property bool AutoUpdate = {read=FAutoUpdate, write=FAutoUpdate, default=1};
	__property bool AutoCreateParam = {read=FAutoCreateParam, write=FAutoCreateParam, default=1};
	__property Rest::Client::TCustomRESTRequest* Request = {read=FRequest, write=SetRequest};
	__property Data::Db::TDataSet* Dataset = {read=GetDataSet, write=SetDataSet};
	...
	__property Data::Dbjson::TJSONDataSetArea Area = {read=GetArea, write=SetArea, default=0};
	__property bool IncludeNulls = {read=GetIncludeNulls, write=SetIncludeNulls, default=0};
...
{
	typedef TCustomRESTRequestDataSetAdapter inherited;
	
__published:
	__property AutoUpdate = {default=1};
	__property AutoCreateParam = {default=1};
	__property Request;
	__property Dataset;
	__property FieldNames;
	__property ParamName = {default=0};
	__property Area = {default=0};
	__property IncludeNulls = {default=0};
	__property OnFilterRecord;
public:
	/* TCustomRESTRequestDataSetAdapter.Create */ inline __fastcall virtual TRESTRequestDataSetAdapter(System::Classes::TComponent* AOwner) : TCustomRESTRequestDataSetAdapter(AOwner) { }
	/* TCustomRESTRequestDataSetAdapter.Destroy */ inline __fastcall virtual ~TRESTRequestDataSetAdapter() { }
