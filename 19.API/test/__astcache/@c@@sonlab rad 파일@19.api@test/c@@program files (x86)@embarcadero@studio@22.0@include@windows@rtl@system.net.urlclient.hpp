...
// (DO NOT EDIT: machine generated header) 'System.Net.URLClient.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TAsyncReadStream;
class DELPHICLASS TURLStream;
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
#pragma pack(push,4)
#endif /* not _WIN64 */
...
public:
	...
	int KeySize;
	System::UnicodeString PublicKey;
	bool __fastcall IsEmpty();
};
...
public:
	...
	/* {System_Generics_Collections}TList<System_Net_URLClient_TCertificate>.Create */ inline __fastcall TCertificateList(const TCertificate *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<TCertificate>(Values, Values_High) { }
...
protected:
	class DELPHICLASS TStreamAsyncResult;
	class PASCALIMPLEMENTATION TStreamAsyncResult : public System::Classes::TBaseAsyncResult
	{
		typedef System::Classes::TBaseAsyncResult inherited;
		
	private:
		TAsyncReadStream* __fastcall GetStream();
	...
	protected:
		...
		virtual void __fastcall Complete();
		virtual bool __fastcall DoCancel();
		__property TAsyncReadStream* Stream = {read=GetStream};
	protected:
	...
	public:
		...
		/* TBaseAsyncResult.Destroy */ inline __fastcall virtual ~TStreamAsyncResult() { }
...
public:
	__interface DELPHIINTERFACE TStreamer;
	typedef System::DelphiInterface<TStreamer> _di_TStreamer;
	__interface TStreamer  : public System::IInterface 
	{
		virtual void __fastcall Invoke(System::Classes::TStream* AStream) = 0 ;
	};
	
	__interface DELPHIINTERFACE TCanceler;
	typedef System::DelphiInterface<TCanceler> _di_TCanceler;
	__interface TCanceler  : public System::IInterface 
	{
		virtual bool __fastcall Invoke(System::Classes::TStream* AStream) = 0 ;
	};
	
	
private:
	TStreamAsyncResult* FAsyncResultObj;
	System::Types::_di_IAsyncResult FAsyncResult;
	unsigned FOwningThread;
	_di_TStreamer FPopulator;
	_di_TStreamer FProvider;
	_di_TCanceler FCanceler;
	bool FSynchronizeProvide;
	bool FFreeOnCompletion;
	System::Classes::TStream* FReadingStream;
	void __fastcall Populate();
	void __fastcall Provide();
	void __fastcall WaitForCompletion();
	void __fastcall CheckWriting();
	static System::Classes::TThreadList* FActiveStreams;
...
protected:
	virtual void __fastcall DoPopulate();
	virtual void __fastcall DoProvide();
	virtual bool __fastcall DoCancel();
	void __fastcall SetReadingStream(System::Classes::TStream* AReadingStream);
	
public:
	__fastcall TAsyncReadStream(const _di_TStreamer APopulator, const _di_TStreamer AProvider, const _di_TCanceler ACanceler, bool ASynchronizeProvide, bool AFreeOnCompletion);
	__fastcall virtual ~TAsyncReadStream();
	...
	__property System::Types::_di_IAsyncResult AsyncResult = {read=FAsyncResult};
	/* Hoisted overloads: */
...
public:
	operator System::Types::IAsyncResult*(void) { return (System::Types::IAsyncResult*)AsyncResult; }
...
{
	typedef TAsyncReadStream inherited;
	
	
public:
	__interface DELPHIINTERFACE TSyncReqExecutor;
	typedef System::DelphiInterface<TSyncReqExecutor> _di_TSyncReqExecutor;
	__interface TSyncReqExecutor  : public System::IInterface 
	{
#ifndef _WIN64
		virtual _di_IURLRequest __fastcall Invoke(TURLClient* AClient, const _di_IURLRequest ARequest, System::Classes::TStream* const AContentStream, const System::DynamicArray<TNameValuePair> AHeaders) = 0 ;
#else /* _WIN64 */
		virtual _di_IURLRequest __fastcall Invoke(TURLClient* AClient, const _di_IURLRequest ARequest, System::Classes::TStream* const AContentStream, const System::TArray__1<TNameValuePair> AHeaders) = 0 ;
#endif /* _WIN64 */
	};
...
private:
	...
	_di_IURLRequest FRequest;
	NativeUInt FModule;
	static System::Generics::Collections::TDictionary__2<System::UnicodeString,_di_TSyncReqExecutor>* FSyncReqExecutors;
...
protected:
	virtual void __fastcall DoPopulate();
	virtual bool __fastcall DoCancel();
	virtual System::Classes::TStream* __fastcall GetFileSchemeStream(const TURI &AURI);
	virtual System::Classes::TStream* __fastcall GetResSchemeStream(const TURI &AURI);
	virtual System::Classes::TStream* __fastcall GetOtherSchemeStream(const TURI &AURI);
	
public:
	__fastcall TURLStream(const System::UnicodeString AURL, const TAsyncReadStream::_di_TStreamer AProvider, bool ASynchronizeProvide, bool AFreeOnCompletion);
	...
	__classmethod void __fastcall UnRegisterSyncReqExecutor(const System::UnicodeString AScheme);
};
