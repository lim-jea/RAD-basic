...
// (DO NOT EDIT: machine generated header) 'Data.DBJson.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TDataSetToJSONBridge;
//-- type declarations -------------------------------------------------------
...
enum class DECLSPEC_DENUM TJSONDataSetArea : unsigned char { All, AllFromCurrent, Current, CurrentAsArray };
...
private:
	...
	static bool __fastcall ContainsArrayOfObjects(System::Json::Readers::TJsonReader* AReader);
...
class PASCALIMPLEMENTATION TDataSetToJSONBridge : public System::TObject
{
	typedef System::TObject inherited;
...
private:
	...
	TJSONDataSetArea FArea;
	Data::Db::TFilterRecordEvent FOnFilterRecord;
	bool FIncludeNulls;
	void __fastcall WriteFieldValues(Data::Db::TFields* AFields, System::Json::Builders::TJSONCollectionBuilder::TPairs* APairs);
	void __fastcall WriteDataSet(Data::Db::TDataSet* ADataSet, System::Json::Builders::TJSONCollectionBuilder::TElements* AElems, TJSONDataSetArea AArea);
	
protected:
	bool __fastcall DoFilterRecord(Data::Db::TDataSet* ADataSet);
	
public:
	__fastcall TDataSetToJSONBridge();
	__fastcall virtual ~TDataSetToJSONBridge();
	...
	__property Data::Db::TDataSet* Dataset = {read=FDataSet, write=FDataSet};
	__property System::Classes::TStrings* FieldNames = {read=FFieldNames};
	__property TJSONDataSetArea Area = {read=FArea, write=FArea, default=0};
	__property bool IncludeNulls = {read=FIncludeNulls, write=FIncludeNulls, default=0};
	__property Data::Db::TFilterRecordEvent OnFilterRecord = {read=FOnFilterRecord, write=FOnFilterRecord};
};
