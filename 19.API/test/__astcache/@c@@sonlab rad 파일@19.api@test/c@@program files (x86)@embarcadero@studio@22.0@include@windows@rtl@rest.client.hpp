...
// (DO NOT EDIT: machine generated header) 'REST.Client.pas' rev: 35.00 (Windows)
...
struct TRESTRequestParameterHelper /* Helper for class 'TRESTRequestParameter*' */;
...
struct TCustomRESTRequestHelper /* Helper for class 'TCustomRESTRequest*' */;
//-- type declarations -------------------------------------------------------
...
private:
	...
	Rest::Types::TRESTContentType FContentTypeStr;
	...
	void __fastcall SetContentTypeStr(const Rest::Types::TRESTContentType AValue);
...
#endif /* _WIN64 */
	void __fastcall ReadContentType(System::Classes::TReader* Reader);
	bool __fastcall ContentTypeStrIsStored();
...
protected:
	...
	virtual void __fastcall ParameterValuesNeeded();
...
public:
	...
	void __fastcall AddBody(System::Classes::TStream* ABodyContent, Rest::Types::TRESTContentType AContentType = Rest::Types::TRESTContentType(), Rest::Types::TRESTObjectOwnership AOwnsStream = (Rest::Types::TRESTObjectOwnership)(0x0))/* overload */;
	void __fastcall ClearBody();
	...
	System::UnicodeString __fastcall GetFullRequestBody();
...
static const System::Word CRestDefaultTimeout = System::Word(0x7530);
#define sRequestDefaultAccept L"application/json, text/plain; q=0.9, text/html;q=0.8,"
#define sRequestDefaultAcceptCharset L"utf-8, *;q=0.8"
#define sDefaultFallbackCharSetEncoding L"utf-8"
#define sDefaultUserAgent L"Embarcadero RESTClient/1.0"
#define sBody L"body"
#define sFile L"file"
}	/* namespace Client */
}	/* namespace Rest */
